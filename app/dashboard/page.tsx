...
const modules = [
  ...
  { number: '15', slug: 'module-15-crewai', title: 'CrewAI', part: 'Part 7 - Framework Electives', status: 'ready', lab: 'Content production pipeline' },
  ...
  { number: '20', slug: 'module-20-anthropic-sdk', title: 'Anthropic Python SDK', part: 'Part 7 - Framework Electives', status: 'ready', lab: 'Production research assistant' },
]
        ...
        <div className="mx-auto max-w-7xl px-6 py-6">
          <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
            ...
            <div className="flex items-center gap-2">
              <Link href="/account" className="rounded-md px-4 py-2 text-sm font-semibold text-zinc-300 transition hover:bg-white/8 hover:text-white">
                Account
              </Link>
              <form action={logOut}>
